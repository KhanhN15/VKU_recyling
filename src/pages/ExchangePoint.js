                ...
                <div>
                            ...
                            <div className="benefit-member__content">
                                <div className="steps-custom">
                                    <ul className="steps-custom__list">
                                        <li className="steps-custom__item active" data-image="./img/doidiem/hoi-vien-tiem-nang.png">
                    ...
                    <section className="box-faq-plus">
                        <div className="faq-plus">
                            <div className="container">
                                <h2 className="section-title">
                                    Câu hỏi thường gặp RECYCLABLE WASTE
                                </h2>
                                <div className="faq-plus__content">
                                    <ul className="faq-plus__list">
                                        <li id="colapse-custom0" className="faq-plus__item">
                                            ...
                                            <div id="colapse-result0" className="faq-plus__info" style={{ display: 'none' }}>
                                                <p className="faq-plus__des">
                                                    ...
                                                    <span style={{ fontSize: 14 }}><span style={{ fontFamily: 'arial,helvetica,sans-serif' }}>Thông thường chu kỳ đạt hạng của khách hàng là 12 tháng kể từ thời điểm đạt hạng. Tuy nhiên hàng tháng hệ thống đều xét hạng lại cho các tài khoản, nếu tài khoản có phát sinh điểm xét hạng đạt hạng mới cao hơn hạng cũ, khách hàng sẽ được lên hạng ngay mà không cần chờ chu kỳ sau 12 tháng.</span></span>
                                                </p>
                                                <p />
                                            </div>
                                        </li>
                                        <li id="colapse-custom1" className="faq-plus__item">
                                            <div className="faq-plus__top">
                                                <h4 className="faq-plus__name">
                                                    Khách hàng A sử dụng hai tài khoản. tài khoản 1 đạt hạng Vàng có 100.000 điểm xét hạng và thuê bao 2 đạt hạng Bạc có 60.000 điểm. Sau khi gộp nhóm khách hàng A sẽ đạt hạng gì?
                                                </h4>
                                                <span className="faq-plus__icon" />
                                            </div>
                                        ...
                                        <li id="colapse-custom2" className="faq-plus__item">
                                            <div className="faq-plus__top">
                                                <h4 className="faq-plus__name">
                                                    Khách hàng có được giữ nguyên hạng từ chương trình Recyclabe waste sang chương trình RV++ hay không?
                                                </h4>
                                                <span className="faq-plus__icon" />
                                            </div>
                                            <div id="colapse-result2" className="faq-plus__info" style={{ display: 'none' }}>
                                                <p className="faq-plus__des">
                                                    ...
                                                    <span style={{ fontSize: 14 }}><span style={{ fontFamily: 'arial,helvetica,sans-serif' }}>Khách hàng đang là hội viên Viettel Privilege sẽ giữ nguyên hạng hội viên hiện tại cho đến hết chu kỳ. Hàng tháng hệ thống xét hạng lại, nếu khách hàng đủ điều kiện lên hạng cao hơn sẽ được lên hạng ngay theo đúng thể lệ chương trình. Điểm quy đổi cũ của chương trình  Privilege (nếu có) được quy đổi sang điểm tích lũy của chương trình RV++ mới theo tỷ lệ: 1 điểm chương trình Recyclable waste Privilege = 20 điểm chương trình Recyclalabe waste.</span></span>
                                                </p>
                                                <p />
                                            </div>
                                        </li>
                                        ...
                                        <li id="colapse-custom4" className="faq-plus__item">
                                            <div className="faq-plus__top">
                                                <h4 className="faq-plus__name">
                                                    Trường hợp tài khoản thành viên đã được gộp nhóm trước đó muốn tách khỏi nhóm có được không và phải làm như thế nào?
                                                </h4>
                                                <span className="faq-plus__icon" />
                                            </div>
